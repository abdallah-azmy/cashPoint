...
DeleteNotificationModel welcomeFromJson(String str) => DeleteNotificationModel.fromJson(json.decode(str));

String welcomeToJson(DeleteNotificationModel data) => json.encode(data.toJson());
