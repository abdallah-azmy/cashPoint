...
AllDataModelForStore welcomeFromJson(String str) => AllDataModelForStore.fromJson(json.decode(str));

String welcomeToJson(AllDataModelForStore data) => json.encode(data.toJson());

class AllDataModelForStore {
  AllDataModelForStore({
    this.mainCode,
    this.code,
    this.data,
    this.error,
  ...
  factory AllDataModelForStore.fromJson(Map<String, dynamic> json) => AllDataModelForStore(
