...
StoreDetailsModel welcomeFromJson(String str) => StoreDetailsModel.fromJson(json.decode(str));

String welcomeToJson(StoreDetailsModel data) => json.encode(data.toJson());
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    ...
    ratesStore: json["ratesStore"] == null ? null : List<RatesStore>.from(json["ratesStore"].map((x) => RatesStore.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
    ...
    "ratesStore": ratesStore == null ? null : List<dynamic>.from(ratesStore.map((x) => x.toJson())),
...
class RatesStore {
  ...
  factory RatesStore.fromJson(Map<String, dynamic> json) => RatesStore(
    id: json["id"] == null ? null : json["id"],
