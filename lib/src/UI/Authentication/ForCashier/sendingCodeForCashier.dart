...
import 'package:cashpoint/src/UI/Authentication/ForCashier/changePasswordCashier.dart';
...
class SendingCodeForCashier extends StatefulWidget {
  final phone;
//  final countryId;
  final typeOfCode;
  final logInType;
  SendingCodeForCashier({this.phone, this.typeOfCode,
//    this.countryId,
    this.logInType});
  @override
  _SendingCodeForCashierState createState() => _SendingCodeForCashierState();
}

class _SendingCodeForCashierState extends State<SendingCodeForCashier> {
