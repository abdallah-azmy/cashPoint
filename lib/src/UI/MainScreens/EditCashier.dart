...
class EditCashier extends StatefulWidget {
  ...
  EditCashier({this.id, this.apiToken, this.getData, this.cashier});
  @override
  State<StatefulWidget> createState() {
    return EditCashierState();
  }
}

class EditCashierState extends State<EditCashier> {
    ...
    await ApiProvider(scaffold, context)
      ...
      if (value.code == 200) {
        ...
        LoadingDialog(scaffold, context)
            .showNotification(localization.text("edited_successfully"));
...
//      governrateController = first.adminArea;
  ...
  void initState() {
    ...
    super.initState();
    getNameOfLocation(widget.cashier.latitude, widget.cashier.longitude);
  }
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        EditTextField(
                          ...
                          hint: "${widget.cashier.description}",
                          moreTanOneLine: true,
                          minLines: 3,
                          maxLines: 3,
                          height: 80,
                                    ...
                                    child: Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: <Widget>[
                                          Text(
                                            chosenLanguage == null
                                                ?  "${widget.cashier.language == "en" ? "english _ انجليزي" : "arabic _ عربي" }"
                                                : "$chosenLanguage",
...
//                                                  : " ",
                        ...
                        _image != null
                            ...
                            : widget.cashier.image != null   ?
                        Padding(
                          padding: const EdgeInsets.all(5.0),
                          child: CachedNetworkImage(
                            fit: BoxFit.cover,
                            imageUrl: "${widget.cashier.image}"
                            ,
                      ...
                      children: <Widget>[
                        Row(
                          ...
                          children: <Widget>[
                            ...
                            Text(
                              localization.text("edit cashier"),
